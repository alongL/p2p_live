...
#define MAX_FLV_FILENAME_LEN    512
#define MAX_FLV_SERVERS 5

struct flv_server {
    int pid;
    char filename[MAX_FLV_FILENAME_LEN];
};

struct flv_s {
    struct flv_server servers[MAX_FLV_SERVERS];
};
#define FLV_SHM_SIZE            (sizeof(struct flv_s))
#endif
