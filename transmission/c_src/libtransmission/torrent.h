...
#define TR_FILE_NAME_LEN 128

typedef struct tr_shmInfo_t
{
    char *              shmFileName[TR_FILE_NAME_LEN];
    tr_piece_index_t    pieceIndex;
    tr_piece_index_t    localPieceIndex;
    struct tr_shmInfo_t *shmNext;    
} tr_shmInfo;
...
struct tr_torrent
{
    ...
    char                       shmResId[MAX_RESID_LEN];
    tr_piece_index_t           lastLocalPieceIndex;
    tr_shmInfo                 *shmInfoList;
};
