...
extern void print_buffer_info (struct buffer_s * buffptr);
extern void parse_flv_stream_data(struct buffer_s * buffptr, int direct, int debug);
extern void init_flv_stream_st(void);
extern int clone_buffer(int need_tag_head, struct buffer_s *dst, struct buffer_s *src);
extern int terminate_server_buffer_at_tag_end(struct buffer_s * buffptr);
extern int move_buffers(struct buffer_s * dst, struct buffer_s * src);
extern void dn_debug_init(void);
